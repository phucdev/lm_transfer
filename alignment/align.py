...
from lm_transfer.utils.utils import *
...
def parse_args():
    ...
    parser.add_argument("--src_tokenizer", type=str, default='', help="Tokenizer for source embeddings")
    parser.add_argument("--tgt_tokenizer", type=str, default='', help="Tokenizer for target embeddings")
...
def main():
    ...
    src_tokenizer = AutoTokenizer.from_pretrained(params.src_tokenizer) if params.src_tokenizer else None
    tgt_tokenizer = AutoTokenizer.from_pretrained(params.tgt_tokenizer) if params.tgt_tokenizer else None
    src_vocabulary = src_tokenizer.get_vocab() if src_tokenizer else None
    tgt_vocabulary = tgt_tokenizer.get_vocab() if tgt_tokenizer else None

    # load word embeddings
    words_tgt, x_tgt = load_vectors(params.tgt_emb, maxload=params.maxload, center=params.center, vocabulary=tgt_vocabulary)
    words_src, x_src = load_vectors(params.src_emb, maxload=params.maxload, center=params.center, vocabulary=src_vocabulary)
